...
def thinker_process(frame_queue, result_queue):
    ...
    image_files = {
        "Fingerprint": ("/home/user/Desktop/FingerPrint2.png", 60),
        "Warning": ("/home/user/Desktop/Caution2.png", 30),
        "Push Button": ("/home/user/Desktop/Button2.png", 60)
    }
...
if __name__ == '__main__':
    ...
    print("=== PID + MULTIPROCESSING VISION BOOTING ===")
    last_error = 0
    I = 0
    ...
    try:
        while True:
                ...
                while not result_queue.empty():
                    ...
                    for sym in found_symbols:
                        ...
                        if sym in ["Push Button", "Warning"]:
                            ...
                            print("   -> ACTION: Spinning 360 degrees!")
                            set_motor(0.7, -0.7) 
                            time.sleep(2.8)      
                            stop()
                            action_taken = True
                            ...
                            print("   -> ACTION: Logging to terminal and driving.")
                            action_taken = True
                            break
                            
                    if action_taken:
                        print(f"   -> IGNORING VISION FOR 2 SECONDS...")
            ...
            if len(valid_color_contours) > 0 and time.time() > arrow_expiry_time:
                ...
                if is_on_shortcut:
                    is_on_shortcut = False
                    print(f"\n[STATE] Exiting Shortcut! Injecting {shortcut_exit_direction} memory!")
            ...
            if target_contour is not None:
                ...
                if area > STOP_LINE_AREA:
                    print(f"Detected stop line! Area: {area} > {STOP_LINE_AREA}")
                    stop()
                    break 
